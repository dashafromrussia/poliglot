...
class DrawerBloc extends Bloc<DrawerEvent,DrawerState>{
  ...
  DrawerBloc({required this.useCaseApp,required this.select}) : super(const ToggleState({'Books': Colors.black,'Main': Colors.black, 'Articles':Colors.black, 'Update': Colors.black,
    'Chats': Colors.black,'Users': Colors.black, 'Exit':Colors.black})) {
